...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <table width="1003" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td class="subheading2"><strong><u><h3>Our Services :-</h3></u></strong><br />
            <br />
            <span class="subheading3"><strong>Why is Sahaay better than other similar providers?</strong></span><br />
            <br />
            <strong>Reliable, top quality services</strong><br />
            <br />
            <span class="para">Only our trusted customers are allowed to recommend us new providers. All our service providers go through extensive training, and thorough background checks, to ensure that you don’t have to compromise on quality and trust.</span><br />
<br />
<strong>Our data is certified</strong><br />
<br />
<span class="para">Before they're posted, all reviews are checked in order to guard against providers and companies that try to report on themselves or their competitors. </span><br />
<br />
<strong>Ease of use</strong><br />
<br />
<span class="para">We will find the best profiles based on your requirements, and  take care of your job getting done. No random calls, no harassment, no anxious moments.  You can sign up with us, and   it gets even easier. You can save your preferences, book services recurringly,request for  re-hiring your  favorite providers.</span><br /></td>
      </tr>
    </table>
    <br />
    <br />
